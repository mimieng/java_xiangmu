...
public class medicinesManageFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        table1 = new JTable();
        label3 = new JLabel("药品名称：");
        txt_name2 = new JTextField();
        label4 = new JLabel("药品简介：");
        txt_info = new JTextField();
        btn_update = new JButton("确认修改");
        label5 = new JLabel("所属类别：");
        cb_category2 = new JComboBox<>(new String[]{"抗生素", "止痛药", "退烧药","解热镇痛药","心血管药","胃药","降压药","止泻药","勃起功能障碍","心血管药"});
        label6 = new JLabel("价格：");
        ...
        tableModel.addColumn("车辆名称");
        tableModel.addColumn("所属类别");
        tableModel.addColumn("车辆简介");
        tableModel.addColumn("月租");
