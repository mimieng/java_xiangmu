...
public class MainFrame1 extends JFrame {
    ...
    public static Student admin;

    public MainFrame1(String mUserType,Student madmin) {
        userType=mUserType;
        admin=madmin;
        initComponents();
        item_psw.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                new EditPswFrame1().setVisible(true);
            }
        });
        item_add.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                new AddEquipFrame1().setVisible(true);
            }
        });
        item_equip.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                new EquipQueryFrame1().setVisible(true);
            }
        });
        ...
        item_quit.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                if(JOptionPane.showConfirmDialog(MainFrame1.this,"确认退出码？")==JOptionPane.OK_OPTION){
                    System.exit(0);
                }
            }
        });
        item_1.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new AddEquipFrame2().setVisible(true);
            }
        });
            }
    ...
    private void initComponents() {
        ...
        //======== menuBar1 ========
        {
            ...
            //======== menuBar4 ========
            {
                ...
                {
                    menu5.setText("\u501f\u7528\u5668\u6750");
                    menu5.setIcon(new ImageIcon(getClass().getResource("/\u73ed\u7ea7\u5217\u8868.png")));

                    //---- item_1 ----
                    item_1.setText("\u501f\u7528\u5668\u6750");
                    item_1.setIcon(new ImageIcon(getClass().getResource("/\u7528\u6237\u540d.png")));
                    menu5.add(item_1);
                }
                menuBar4.add(menu5);
            }
